...
const socials = [
  ...
  },
  {
    ...
    icon: '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>',
  },
];
</script>

<template>
  <footer id="contact" class="border-t border-purple-500/10">
    <div
      class="mx-auto max-w-6xl px-6 py-20 text-center"
    >
      ...
      <p class="mt-8 text-sm text-gray-600">
        &copy; {{ new Date().getFullYear() }} Branell Kaunda. All rights reserved.
      </p>
    </div>
  </footer>
</template>
